...
export function initAuditManagementModule(container) {
  ...
  const loadAuditLogs = () => {
    ...
    const mockLogs = [
      { id: '1', actor: 'superadmin@parking.go', action: 'UPDATE_TARIFF', entity_type: 'tariff_rules', ip_address: '118.70.12.33', created_at: '2026-08-11 09:30:00', old_data: { monthly_fee: 1000000 }, new_data: { monthly_fee: 1200000 } },
