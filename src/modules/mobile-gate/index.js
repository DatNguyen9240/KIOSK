  ...
  container.innerHTML = `
    <div class="max-w-md mx-auto bg-slate-900 min-h-[600px] rounded-[40px] border-8 border-slate-800 p-4 text-white shadow-2xl flex flex-col justify-between select-none">
      ...
      <div class="space-y-4 my-auto py-6">
        ...
        <button type="button" id="guard-open-barrier-btn" class="w-full py-5 bg-emerald-600 hover:bg-emerald-500 active:scale-98 text-white font-black rounded-3xl shadow-lg shadow-emerald-600/40 text-base flex items-center justify-center gap-3 transition">
